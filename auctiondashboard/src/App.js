  ...
  return (
    <div style={{ padding: 20, background: 'linear-gradient(135deg, #e3f2fd 0%, #fffde7 100%)', minHeight: '100vh' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 24 }}>
        <h1 style={{ color: '#283593', fontWeight: 'bold', fontSize: 32 }}>FBL Team's Tournament Auction Dashboard</h1>
      </div>
      {/* Teams in a row */}
      <div style={{ display: 'flex', flexDirection: 'row', gap: 20, marginBottom: 40 }}>
        {teams.map(team => {
